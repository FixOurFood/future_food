...
from .model.land import *
from .model.food import *
from .model.utils import generate_API_url
...
def pipeline_setup(
    ...
    pipeline.add_node(
        ...
        name="Scale consumer demand"
    )
    
    pipeline.add_node(
        alternative_food_model,
        {
    ...
    pipeline.add_node(
        ...
        name="Scale food waste"
    )

    pipeline.add_node(
        production_land_scale,
        {
            "bdleaf_conif_ratio": params["bdleaf_conif_ratio"]/100
        },
        name="Scale production land"
    )

    # # Land management
    # pipeline.add_node(
    #     forest_land_model_new,
    #     {
    #         "forest_fraction": params["foresting_pasture"]/100,
    #         "bdleaf_conif_ratio": params["bdleaf_conif_ratio"]/100
    #     },
    #     name="Convert pasture to forest"
    # )
    ...
    pipeline.add_node(
        ...
        name="Convert arable land to BECCS crops"
    )
    ...
    pipeline.add_node(
        ...
        name="Convert pasture land to BECCS crops"
    )
    ...
    pipeline.add_node(
        ...
        name="Shift production to horticulture"
    )
    ...
    pipeline.add_node(
        ...
        name="Shift production to pulses"
    )
    ...
    pipeline.add_node(
        ...
        name="Increase soil carbon in arable land"
    )
    ...
    pipeline.add_node(
        agroecology_model,
        {
            ...
            + (1 - adv_settings["agroecology_tree_coverage"]
               ) * adv_settings["managed_pasture_seq_ha_yr"],
        },
        name="Adopt silvopasture"
    )
    ...
    pipeline.add_node(
        ...
        name="Adopt nitrogen management"
    )
    ...
    pipeline.add_node(
        ...
        name="Adopt fossil-free livestock feed"
    )
    ...
    pipeline.add_node(
        ...
        name="Increase livestock yields"
    )
    ...
    pipeline.add_node(
        ...
        name="Scale livestock production with yield increase"
    )
    ...
    pipeline.add_node(
        ...
        name="Adopt fossil-free arable farming"
    )
    ...
    pipeline.add_node(
        ...
        name="Adopt carbon capture and storage"
    )

    pipeline.add_node(
        label_new_forest,
        name="Label new forest land"
    )

    # Compute emissions and sequestration
    pipeline.add_node(
        forest_sequestration_model,
        {
        ...
        name="Compute forest sequestration"
    )
